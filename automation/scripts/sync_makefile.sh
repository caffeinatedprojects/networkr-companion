...
do
	...
	sudo cp $TEMPLATE_PATH/Makefile $USER_PATH/Makefile
	sudo chown $USER:$USER $USER_PATH/Makefile

	sudo cp $TEMPLATE_PATH/docker-compose.yml $USER_PATH/docker-compose.yml
	sudo chown $USER:$USER $USER_PATH/docker-compose.yml

	sudo cp $TEMPLATE_PATH/_config.yml $USER_PATH/_config.yml
	sudo chown $USER:$USER $USER_PATH/_config.yml
	
	sudo cp $TEMPLATE_PATH/conf.d/php.ini $USER_PATH/conf.d/php.ini
