...
NGINX_PROXY_EMAIL_ADDRESS=networkr@caffeinatedprojects.com
...
git clone --recurse-submodules https://github.com/evertramos/nginx-proxy-automation.git ~/server/proxy/
